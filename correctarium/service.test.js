...
test("prepareResponse converts data to json for response", () => {
    ...
    expect(prepareResponse(200, 3600000, new Date(2017, 1, 10, 12, 0, 0, 0))).toEqual(response);
...
test("parseRequest", () => {
    ...
    expect(parseRequest(request)).toEqual(afterParsing);
    ...
    expect(parseRequest(request1)).toEqual(afterParsing1);
});
