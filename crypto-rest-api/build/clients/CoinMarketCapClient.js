...
class CoinMarketCapClient {
    constructor() {
        this.API_KEY = process.env.COIN_MARKET_CAP_API_KEY;
        this.API_URL = process.env.COIN_MARKET_CAP_URL;
    }
            ...
            result.forEach((symbol) => {
                ...
                if (name) {
                    response.push({
                        ...
                        market: Markets_1.default.COIN_MARKET_CAP,
                        createdAt: new Date(),
                        name,
                    });
                }
...
exports.default = CoinMarketCapClient;
