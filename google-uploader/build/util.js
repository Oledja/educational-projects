...
exports.getShortLink = exports.getImageName = exports.getTokens = exports.saveTokens = void 0;
const fs = __importStar(require("fs"));
const path_1 = __importDefault(require("path"));
const axios_1 = __importDefault(require("axios"));
const api_key_1 = __importDefault(require("./keys/api-key"));
...
function getShortLink(link) {
    return __awaiter(this, void 0, void 0, function* () {
        const resp = yield (0, axios_1.default)({
            ...
            method: `post`,
            headers: {
                Authorization: `Bearer ${api_key_1.default.api_key}`,
            },
            data: {
                url: link
            }
